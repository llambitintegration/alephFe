...
- [ ] 3.1 Replace the scattered per-frame accessor calls in `marathon-web/src/render.rs` (`~245-265,309,451-459,467-473`) with a single `render_snapshot()` per frame, feeding the data-texture upload from `snapshot.poly_dynamic`
