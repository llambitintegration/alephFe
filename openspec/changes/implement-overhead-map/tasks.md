...
- [ ] 3.9 Add unit test: classify a line with IS_CONTROL_PANEL side as ControlPanel regardless of SOLID flag.
- [ ] 3.10 Add unit test: classify a solid line adjacent to a Platform polygon as Platform.
- [ ] 3.11 Add unit test: classify a line with ELEVATION flag (no higher priority) as ElevationChange.
- [ ] 3.12 Add unit test: polygon_fill_color for a polygon with water media returns dark blue RGBA.
- [ ] 3.13 Add unit test: polygon_fill_color for a Platform polygon with no media returns dark red RGBA.
